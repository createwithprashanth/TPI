...
def get_lookups(project_id: str) -> dict:
    ...
    return {
        ...
        "status_options": ["Draft", "For Review", "Issued for Design", "Issued for Construction", "As-Built", "On Hold"],
        "category_options": ["field_device", "final_element", "controller", "analyzer", "safety", "other"],
...
def _map_instrumap_row(raw: dict, project_id: str, batch_id: str, pdf_filename: str, extraction_session_id: str | None) -> dict:
    ...
    confidence = {
        ...
        "service": _service_confidence(raw.get("Service_Confidence")),
    }
    return {
        ...
        "loop_number": _clean(raw.get("Loop")),
        "area_code": _clean(raw.get("Area")),
        "line_tag": _clean(raw.get("Connected_Line")),
        ...
        "status": "For Review" if review_required else "Draft",
