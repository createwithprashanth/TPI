...
SOFT_DISPLAY_CONTROLLER_TYPES = frozenset({"CC", "FIC", "FI", "HIC", "LIC", "LI", "LC", "PIC", "PI", "TIC", "TI"})
...
TYPE_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    "FE": {"io_type": "None", "signal_type": "None", "category": "passive", "flowsizing_type": "flow-element"},
    "RO": {"io_type": "None", "signal_type": "None", "category": "passive", "flowsizing_type": "flow-element"},
    "FT": {"io_type": "AI", "signal_type": "4-20mA + HART", "category": "field_device"},
    "FIT": {"io_type": "AI", "signal_type": "4-20mA + HART", "category": "field_device"},
    "FI": {"io_type": "Soft Link", "signal_type": "", "category": "field_device"},
    "FIC": {"io_type": "Soft Link", "signal_type": "", "category": "controller"},
    ...
    "PI": {"io_type": "Soft Link", "signal_type": "", "category": "field_device"},
    "PIC": {"io_type": "Soft Link", "signal_type": "", "category": "controller"},
    "TT": {"io_type": "AI", "signal_type": "4-20mA + HART", "category": "field_device"},
    "TIT": {"io_type": "AI", "signal_type": "4-20mA + HART", "category": "field_device"},
    "TE": {"io_type": "None", "signal_type": "None", "category": "passive"},
    "TW": {"io_type": "None", "signal_type": "None", "category": "passive"},
    "TI": {"io_type": "Soft Link", "signal_type": "", "category": "field_device"},
    "TIC": {"io_type": "Soft Link", "signal_type": "", "category": "controller"},
    "LT": {"io_type": "AI", "signal_type": "4-20mA + HART", "category": "field_device"},
    "LIT": {"io_type": "AI", "signal_type": "4-20mA + HART", "category": "field_device"},
    "LI": {"io_type": "Soft Link", "signal_type": "", "category": "field_device"},
    "LIC": {"io_type": "Soft Link", "signal_type": "", "category": "controller"},
    "LC": {"io_type": "Soft Link", "signal_type": "", "category": "controller"},
    "CC": {"io_type": "Soft Link", "signal_type": "", "category": "controller"},
    "HIC": {"io_type": "Soft Link", "signal_type": "", "category": "controller"},
    ...
    "CVZI": {"io_type": "DI", "signal_type": "24VDC (Dry Contact)", "category": "field_device"},
    "CVZT": {"io_type": "AI", "signal_type": "4-20mA + HART", "category": "field_device"},
    "FZT": {"io_type": "AI", "signal_type": "4-20mA + HART", "category": "field_device"},
